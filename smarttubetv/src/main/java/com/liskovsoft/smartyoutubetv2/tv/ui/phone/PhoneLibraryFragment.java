...
/**
 * Library/History tab — vertical grid of recently watched videos.
 * Display-only fragment. Data is pushed from PhoneBrowseActivity.
 */
public class PhoneLibraryFragment extends Fragment {
    private static final String TAG = PhoneLibraryFragment.class.getSimpleName();
    ...
    private void updateEmptyState() {
        if (mEmptyText != null) {
            ...
            mEmptyText.setText("No watch history");
        }
    }
