...
class PlayerPreferences @Inject constructor(
    ...
    suspend fun setPeerTubeVideoSearchLimit(limit: Int) {
        Log.d(TAG, "setPeerTubeVideoSearchLimit: $limit")
        context.playerDataStore.edit { it[Keys.PEERTUBE_VIDEO_SEARCH_LIMIT] = limit }
    }
